namespace CustomerClass
{
    public class Customer
    {
        ...
        // AccountNo with privat set, as its being autogenerated within the program.
        ...
        public Customer(string firstName, string lastName, double kwhUsed, decimal billamount)
        {
            ...
            LastName = lastName;
            Kwh = kwhUsed;
            BillAmount = UpdateBillAmount(); // Calling Method to generate an updated bill for the appropriate textbox in the GUI

            totalCustomers++; //Accumulating total customers added
            averageBill += BillAmount; //Updating Average bill while new Cx gets created.
        }
        ...
        {
            if (Kwh < 0)
            { // Throw exception if KwH is below 0.
                throw new ArgumentException("Kwh cannot be less than 0");
            }
            return (Kwh * 0.07) + 12;
        }
        ...
        public static decimal GetAverageBill()
        {
